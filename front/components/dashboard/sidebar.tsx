  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border-none text-xs font-semibold cursor-pointer transition-all flex-shrink-0"
          style={{
      ...
      >
        {records.map((record) => {
          ...
          return (
            ...
            >
              <div className="font-semibold text-sm mb-0.5" style={{ color: '#E8F4F0' }}>
                {record.name}
              </div>
              <div
      ...
      {/* Stats */}
      <div
        className="p-3 border-t grid grid-cols-2 gap-1.5 flex-shrink-0"
        style={{
          borderColor: 'rgba(0,200,150,0.15)',
        }}
      >
